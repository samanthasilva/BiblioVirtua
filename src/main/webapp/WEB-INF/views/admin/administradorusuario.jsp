...
<head>
    ...
    <title>BiblioVirtua - Administrador Usuario</title>
...
<script type="text/javascript" charset="utf-8"  src="<c:url value="/resources/jquery/ajax/ajax_administradorusuario.js" />"></script> 
    ...
    <div class="container-fluid">
        ...
        <header class="row">
            <jsp:include page="/resources/template/admin/menu.jsp">
                <jsp:param name="active" value="administradorusuario" />
            </jsp:include> 
        </header>
            ...
            <div role="main">
                <div class="col-md-12 col-md-offset-0">
                    ...
                    <ul class="breadcrumb">
                      ...
                      <li class="active">Administrador Usuario</li>
                    </ul>
                    ...
                    <table id="tabelausuario" class="table table-responsive table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="active">
                                ...
                                <td name="tb_permissao" id="${usuario.perfil}">${usuario.perfil}</td>
                                 
                                 <td>
                                    <button type="submit" class="btn btn-primary btn-sm btn-novasenha"data-toggle="modal" data-target="#modalNovaSenha" name="novasenha">
                                ...
                                <td>
                                    <button type="submit" class="btn btn-primary btn-sm btn-editar"data-toggle="modal" data-target="#modalEditaUsuario" name="editarusuario">
                                ...
                                <td>
                                    <button type="submit" class="btn btn-danger btn-sm btn-remover" name="excluirusuario">
                    ...
                    <div class="col-md-offset-9">
                        <br>
                        <button type="submit" class="btn" data-toggle="modal" data-target="#modalAdicionaUsuario"/>
