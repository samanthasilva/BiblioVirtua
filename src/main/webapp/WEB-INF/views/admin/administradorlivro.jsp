...
<head>
    ...
    <title>BiblioVirtua - Administrador Livro</title>
...
<script type="text/javascript" charset="utf-8"  src="<c:url value="/resources/jquery/ajax/ajax_administradorlivro.js" />"></script> 
...
<script src="<c:url value="/resources/jquery/validator/views/administradorlivro.js" />"></script>    
</head>
    ...
    <div class="container-fluid">
        ...
        <header class="row">
            <jsp:include page="/resources/template/admin/menu.jsp">
                <jsp:param name="active" value="administradorlivro" />
            </jsp:include> 
        </header>
            ...
            <div role="main">
                <div class="col-md-12 col-md-offset-0">
                    ...
                    <ul class="breadcrumb">
                      ...
                      <li class="active">Administrador Livro</li>
                    </ul>
                    ...
                    <form action="filtrolivro" method="POST">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="opcaopesquisa" id="op_pesq_isbn" value="isbn" checked>Código
                        </label>
                        ...
                        <div class="input-group">
                          <input type="number" class="form-control" name="isbn" id="search_isbn" placeholder="Código do livro">
                        ...
                        <tbody>
                             <c:forEach var="livro" items="${listalivros}" > 
                                    <tr class="active">
                                        ...
                                        <td style="display:none;" name="tb_id">${livro.id}</td>
                                        ...
                                        <td>
                                            <button type="submit" class="btn btn-primary btn-sm btn-editar"data-toggle="modal" data-target="#modalEditaLivro" name="editarlivro">
                                        ...
                                        <td>
                                            <button type="submit" class="btn btn-danger btn-sm btn-remover" name="excluirlivro">
                    ...
                    <div class="col-md-offset-9">
                        <br>
                        <button type="submit" class="btn" data-toggle="modal" data-target="#modalAdicionaLivro"/>
